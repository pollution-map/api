...
public class AuthController : ControllerBase
{
    ...
    /// <remarks>Generate Refresh-Access token pair for JWT Bearer Authentication. You may want to confirm email before login.</remarks>
    ...
    /// <response code="403">
    /// Could not authorize. 
    /// Invalid user credentials or unconfirmed email.</response>
    [HttpPost("login")]
