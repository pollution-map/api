        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    HasBeenCreatedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    WillExpireOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DatasetsItems_Datasets_DataSetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapUIId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataSetId = table.Column<Guid>(type: "uuid", nullable: false),
                    UIElementId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatasetsProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DatasetsProperties_Datasets_DataSetId",
                        column: x => x.DataSetId,
                        principalTable: "Datasets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatasetsPropertiesValues", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DatasetsPropertiesValues_DatasetsProperties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Datasets_MapId",
                table: "Datasets",
                column: "MapId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DatasetsItems_DataSetId",
                table: "DatasetsItems",
                column: "DataSetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DatasetsPropertiesValues_DatasetItemId",
                table: "DatasetsPropertiesValues",
                column: "DatasetItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DatasetsPropertiesValues_PropertyId",
                table: "DatasetsPropertiesValues",
                column: "PropertyId");
