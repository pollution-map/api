...
namespace PollutionMapAPI.Migrations
{
    ...
    [Migration("20220613180508_UIElements")]
    partial class UIElements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatasetPropertyUIElement", b =>
                {
                    b.Property<long>("PropertiesId")
                        .HasColumnType("bigint");

                    b.Property<Guid>("UIElementsId")
                        .HasColumnType("uuid");

                    b.HasKey("PropertiesId", "UIElementsId");

                    b.HasIndex("UIElementsId");

                    b.ToTable("DatasetPropertyUIElement");
                });
            ...
            modelBuilder.Entity("PollutionMapAPI.Data.Entities.DatasetProperty", b =>
                {
                    ...
                    b.HasIndex("DataSetId", "PropertyName")
                        .IsUnique();
            ...
            modelBuilder.Entity("PollutionMapAPI.Data.Entities.UI", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DatasetPropertyUIElement", b =>
                {
                    b.HasOne("PollutionMapAPI.Data.Entities.DatasetProperty", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PollutionMapAPI.Data.Entities.DatasetPropertyValue", b =>
                {
                    b.HasOne("PollutionMapAPI.Data.Entities.DatasetItem", "DatasetItem")
            ...
            modelBuilder.Entity("PollutionMapAPI.Data.Entities.UI", b =>
                {
                    b.HasOne("PollutionMapAPI.Data.Entities.Map", "Map")
                        .WithOne("UI")
                        .HasForeignKey("PollutionMapAPI.Data.Entities.UI", "MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PollutionMapAPI.Data.Entities.UIElement", b =>
                {
                    b.HasOne("PollutionMapAPI.Data.Entities.UI", "UI")
                        .WithMany("Elements")
                        .HasForeignKey("UIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
